...
ECOS_VARIABLES = [
    ...
    ("kr_corp_aa3y",    "817Y002", "010320000", "D", "국내금리", "회사채 AA- 3년"),
    ("kr_cd_91d",       "817Y002", "010150000", "D", "국내금리", "CD 91일"),
    ...
    # CPI(월별) — 901Y009 (신지수, 2020=100)
    ("kr_cpi",          "901Y009", "0",         "M", "국내인플", "소비자물가지수"),
    ("kr_cpi_core",     "901Y009", "QA",        "M", "국내인플", "근원 CPI(농산물·석유 제외)"),
    ...
    # 제조업 BSI(월별) — 512Y014
    ("kr_mfg_bsi_outlook", "512Y014", "AX1AAA", "M", "국내실물", "제조업 BSI 업황전망"),
]
...
FRED_VARIABLES = [
    ...
    ("us_hy_oas",        "BAMLH0A0HYM2", "D", "위험",     "미국 하이일드 OAS"),
